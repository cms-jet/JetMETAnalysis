...
process.partons4jets = cms.EDFilter("PdgIdAndStatusCandViewSelector",
    status = cms.vint32(3),
...
process.kt4GenToParton = cms.EDFilter("MatchRecToGen",
    srcGen = cms.InputTag("partons4jets"),
...
process.kt4GenToCalo = cms.EDFilter("MatchRecToGen",
...
process.rsp_kt4calo = cms.Path(process.kt4GenPtEta+process.partons4jets+process.kt4GenToParton+process.kt4CaloPtEta+process.kt4GenToCalo+process.kt4calo)
