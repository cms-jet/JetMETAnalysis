...
bin: jet_inspect_profiles jet_inspect_histos jet_inspect_graphs jet_calcxsec
...
jet_calcxsec:
	$(CXX) $(CXXFLAGS) bin/jet_calcxsec_x.cc $(LIBS) $(ROOTLIBS) \
        -o $(BINDIR)/jet_calcxsec_x
