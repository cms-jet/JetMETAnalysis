...
string getAlias(TString s)
{
   if (s=="ic5calo")
      ...
      return "AK5CaloHLTl1";
	 else if (s=="ak5caloHLTl1l2")
		  return "AK5CaloHLTl1l2";
   else if (s=="ak4caloHLT")
      return "AK4CaloHLT";
   else if (s=="ak4caloHLTl1")
      return "AK4CaloHLTl1";
	 else if (s=="ak4caloHLTl1l2")
		  return "AK4CaloHLTl1l2";
	 else if (s=="ak4caloHLTl2")
		  return "AK4CaloHLTl2";
   else if (s=="ak8caloHLT")
      return "AK8CaloHLT";
   else if (s=="ak8caloHLTl1")
      return "AK8CaloHLTl1";
	 else if (s=="ak8caloHLTl1l2")
		  return "AK8CaloHLTl1l2";
   else if (s=="ak5pf")
      return "AK5PF";
   else if (s=="ak5pfl1")
      return "AK5PFl1";
      ...
      return "AK4PFHLT";  //added in 2014/04/17
   else if (s=="ak4pfHLTl1")
      return "AK4PFHLTl1";  //added in 2014/04/17
   else if (s=="ak4pfHLTl1l2")
      return "AK4PFHLTl1l2";  //added in 2014/04/17
   else if (s=="ak4pfHLTl2")
      return "AK4PFHLTl2";  //added in 2014/04/17
   else if (s=="ak8pfHLT")
      return "AK8PFHLT";  //added in 2015/05/04
   else if (s=="ak8pfHLTl1")
      return "AK8PFHLTl1";  //added in 2015/05/04
   else if (s=="ak8pfHLTl1l2")
      return "AK8PFHLTl1l2";  //added in 2015/05/04
